...
class restore_ejsapp_activity_task extends restore_activity_task {
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('VRLABINDEX', '/mod/ejsapp/index.php?id=$1', 'course');
        $rules[] = new restore_decode_rule('VRLABVIEWBYID', '/mod/ejsapp/view.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('VRLABVIEWBYU', '/mod/ejsapp/view.php?u=$1', 'ejsapp');
