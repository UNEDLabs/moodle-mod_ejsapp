...
class backup_ejsapp_activity_structure_step extends backup_activity_structure_step
{
    ...
    protected function define_structure()
    {
        ...
        $remlab_manager_exp2practs = new backup_nested_element('remlab_manager_exp2practs');
        $remlab_manager_exp2prc = new backup_nested_element('block_remlab_manager_exp2prc',
        ...
        $ejsapp->add_child($remlab_manager_exp2practs);
        ...
        $remlab_manager_exp2practs->add_child($remlab_manager_exp2prc);
        ...
        if ($is_remlab_manager_installed) {
            $remlab_manager_exp2prc->set_source_table('block_remlab_manager_exp2prc', array('ejsappid'  => '../../id'));
        }
