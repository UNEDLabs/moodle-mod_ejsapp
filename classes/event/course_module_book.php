...
/**
 * Class for logging the need to book event of an EJSApp
 *
 * @package    mod_ejsapp
...
class course_module_book extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_book', 'ejsapp');
    }
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' attempted to access the EJSApp remote lab with id '{$this->objectid}'
         but needed to make a booking before.";
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'ejsapp', 'need_to_book', 'view.php?id=' . $this->objectid,
