...
class course_module_wait extends \core\event\base {
    ...
    public function get_description() {
        return "User {$this->userid} attempted to work with the EJSApp remote lab with id {$this->objectid} but needed to wait.";
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'ejsapp', 'need_to_wait', 'view.php?n=' . $this->objectid,
