...
$string['server_id_description'] = "ID used for registering this Moodle site in Sarlab IRS (http://sarlabirs.dia.uned.es). Leave it blank if the site is not registered";
