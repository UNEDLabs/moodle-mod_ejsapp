...
$string['server_id_description'] = "ID usado para registrar este sitio Moodle en Sarlab IRS (http://enlargeirs.dia.uned.es). Dejar en blanco si el sitio no ha sido registrado";
