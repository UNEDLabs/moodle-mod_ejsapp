...
$string['collaborative_port_description'] = "Puerto usado para establecer la comunicaci&oacute;n en las sesiones colaborativas (requiere el bloque EJSApp collab sessions)";
$string['sarlab_IP'] = "Direcci&oacute;n IP del servidor Sarlab";
