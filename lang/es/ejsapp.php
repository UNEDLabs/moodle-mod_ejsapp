...
$string['func_blockly'] = 'Variable que almacena la función del controlador';
$string['languageController_blockly'] = 'Lenguaje de programación para reescribir funciones';
...
$string['controller_blockly'] = "Controladores";
