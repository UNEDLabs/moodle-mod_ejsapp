...
function add_blockly_html() {
    global $CFG;

    $button = html_writer::tag("button", "Experiments", array("class" => "btn btn-secondary dropdown-toggle",
        "type" => "button", "id" => "dropdownMenuButton", "data-toggle" => "dropdown", "aria-haspopup" => "true",
        "aria-expanded" => "false"));
    $a = html_writer::tag("a", html_writer::tag("i", "", array("class" => "fa fa-plus", "aria-hidden" => "true")) .
        " New experiment script", array("class" => "dropdown-item", "onclick" => "newScript(1)", "style" => "cursor:pointer;"));
    $div = html_writer::div($a, "dropdown-menu", array("id" => "experimentsScripts", "aria-labelledby" => "dropdownMenuButton"));
    $experimentsdropdown = html_writer::div($button . $div, "dropdown", array("id" => "experimentsDropdown"));

    $button = html_writer::tag("button", "Data & Charts", array("class" => "btn btn-secondary dropdown-toggle",
        "type" => "button", "id" => "dropdownMenuButton", "data-toggle" => "dropdown", "aria-haspopup" => "true",
        "aria-expanded" => "false"));
    $a = html_writer::tag("a", html_writer::tag("i", "", array("class" => "fa fa-plus", "aria-hidden" => "true")) .
        " New chart script", array("class" => "dropdown-item", "onclick" => "newScript(2)", "style" => "cursor:pointer;"));
    $div = html_writer::div($a, "dropdown-menu", array("id" => "chartsScripts", "aria-labelledby" => "dropdownMenuButton"));
    $chartsdropdown = html_writer::div($button . $div, "dropdown", array("id" => "chartsDropdown"));

    $button = html_writer::tag("button", "Events", array("class" => "btn btn-secondary dropdown-toggle",
        "type" => "button", "id" => "dropdownMenuButton", "data-toggle" => "dropdown", "aria-haspopup" => "true",
        "aria-expanded" => "false"));
    $a = html_writer::tag("a", html_writer::tag("i", "", array("class" => "fa fa-plus", "aria-hidden" => "true")) .
        " New event script", array("class" => "dropdown-item", "onclick" => "newScript(3)", "style" => "cursor:pointer;"));
    $div = html_writer::div($a, "dropdown-menu", array("id" => "eventscripts", "aria-labelledby" => "dropdownMenuButton"));
    $eventsdropdown = html_writer::div($button . $div, "dropdown", array("id" => "eventsDropdown"));

    $button = html_writer::tag("button", "Controllers", array("class" => "btn btn-secondary dropdown-toggle",
        "type" => "button", "id" => "dropdownMenuButton", "data-toggle" => "dropdown", "aria-haspopup" => "true",
        "aria-expanded" => "false"));
    $a = html_writer::tag("a", html_writer::tag("i", "", array("class" => "fa fa-plus", "aria-hidden" => "true")) .
        " New controller script", array("class" => "dropdown-item", "onclick" => "newScript(4)", "style" => "cursor:pointer;"));
    $div = html_writer::div($a, "dropdown-menu", array("id" => "controllersScripts", "aria-labelledby" => "dropdownMenuButton"));
    $controllersdropdown = html_writer::div($button . $div, "dropdown", array("id" => "controllersDropdown"));

    $a = html_writer::tag("a", html_writer::tag("i", "", array("class" => "fa fa-bug", "aria-hidden" => "true")) .
        " Logs", array("onclick" => "showLog()", "style" => "cursor:pointer;"));
    $logs = html_writer::div($a, "topnav-right");

    $childnavbarcontent = $experimentsdropdown . $chartsdropdown . $eventsdropdown . $controllersdropdown . $logs;
    $childnavbar = html_writer::div($childnavbarcontent, "navbar");
    $parentnavbar = html_writer::div($childnavbar, "navbar2", array("style" => "margin-top:1rem"));

    $textExecution =
        html_writer::start_div("d-flex justify-content-center flex-wrap", array("id" => "textExecution", "style" =>
            "z-index:90;margin-top:1rem;background:white;width:100%;border:2px solid #333; 
            -moz-border-radius-bottomright:5px;-moz-border-radius-bottomleft:5px;
            -webkit-border-bottom-right-radius:5px; -webkit-border-bottom-left-radius:5px;")) .
            html_writer::start_div("d-flex justify-content-center", array("id" => "prepareSelectionsMenu")) .
            ...
            html_writer::start_div("d-flex justify-content-center") .
                html_writer::tag("button", "Run", array("class" => "textExecutionElement",
                    "onclick" => "playCode()", "id" => "Run", "style" => "height:2em;cursor:pointer;background-color:white;
                    border-style:ridge;border-radius:5px; font-color:#111;font-family:'Helvetica Neue',sans-serif;
    ...
    $chartsdiv =
        html_writer::start_div("", array("id" => "ChartBox", "style" => "display:none;")) .
            html_writer::start_div("topnav-right align-self-end") .
                ...
                html_writer::tag("i", "", array("id" => "save_chart", "onclick" => "saveImg('" .
                    $CFG->wwwroot . "/mod/ejsapp/upload_file.php" . "')",
                    "class" => "fa fa-area-chart fa-2x", "style" => "cursor:pointer;margin-right:0.5rem;")) .
                html_writer::tag("i", "", array("id" => "save_chart", "onclick" => "saveCSV(0)",
                    "class" => "fa fa-file-text-o fa-2x", "style" => "cursor:pointer;margin:0 0.5rem 0 0.5rem;")) .
                html_writer::tag("i", "", array("id" => "full_screen_chart", "class" =>
                    "fa fa-expand fa-2x", "aria-hidden" => "true", "style" => "cursor:pointer;margin-left:0.5rem;")) .
            ...
            html_writer::start_div("d-flex flex-column", array("id" => "slideshow-wrapper", )) .
                html_writer::start_div("d-flex justify-content-center", array("style" => "order:99;")) .
                    html_writer::tag("i", "", array("id" => "prev_chart", "onclick" => "prevChart()",
                        "class" => "fa fa-angle-double-left fa-2x", "style" => "display:none;cursor:pointer;")) .
                    html_writer::tag("i", "", array("id" => "clean_chart", "onclick" => "cleanCharts()",
                        "class" => "fa fa-times fa-2x", "style" => "display:none;cursor:pointer;")) .
                    html_writer::tag("i", "", array("id" => "next_chart", "onclick" => "nextChart()",
                        "class" => "fa fa-angle-double-right fa-2x", "style" => "display:none;cursor:pointer;")) .
                html_writer::end_div() .
            html_writer::end_div() .
        html_writer::end_div();

    $blocklydiv =
        html_writer::start_div("box", array("id" => "ScriptBox", "style" => "display:none;min-width:40%px;height:100%;")) .
            html_writer::start_div("d-flex justify-content-between") .
                html_writer::tag("h3", "", array("id" => "titleScriptBox", "style" => "height:10%;")) .
                html_writer::tag("i", "", array("class" => "fa fa-expand fa-2x", "id" =>
                    "full_screen_blockly", "aria-hidden" => "true", "style" => "cursor:pointer;")) .
            html_writer::end_div() .
            html_writer::start_div("", array("id" => "whereScriptsAre", "style" => "text-align:center;height:90%;")) .
                ...
                html_writer::div("", "", array("id" => "blocklyDivEvents",
                    "style" => "display:none;height:100%;width:100%;")) .
                html_writer::start_div("", array("id" => "ControllerDiv", "style" => "height:90%;width:100%;")) .
    ...
    $logdiv =
        html_writer::start_div("", array("id" => "footer", "style" => "display:none;text-align:center;")) .
            ...
            html_writer::tag("textarea", "Errors:", array("id" => "errorArea", "readonly" => "true",
                "style" => "border:none;resize:none;height:100px;width:80%;text-align:left;border-color:grey;color:#111; 
                font-family:'Helvetica Neue',sans-serif;font-size:14px;font-weight:bold;letter-spacing:-1px;
                line-height:1;")) .
        html_writer::end_div();

    return [
        $chartsdiv,
        $parentnavbar . $textExecution,
        $blocklydiv,
        $logdiv
    ];
}
