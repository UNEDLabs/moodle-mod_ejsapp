...
function update_links($codebase, $ejsapp, $code, $use_css) {
    ...
    $search = '<link rel="stylesheet"  type="text/css" href="' . $path . 'css/style.css' . '" />';
    $code = str_replace($search,$replace,$code);
...
function create_blockly_configuration($ejsapp) {
   ...
   $blockly_conf = json_decode($ejsapp->blockly_conf);
    if ($blockly_conf[0] == 1) {
        ...
        $lab_functions = "'<category name=\"" . get_string('xml_lab_functions', 'ejsapp') . "\"><block type=\"play_lab\"></block><block type=\"pause_lab\"></block><block type=\"initialize_lab\"></block><block type=\"reset_lab\"></block></category>'";
