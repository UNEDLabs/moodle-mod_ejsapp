...
/* EXPERIMENTS */
Blockly.Msg["ExpSTART"] = "arranca el laboratorio";
Blockly.Msg["ExpSTARTFOR"] = "ejecuta el laboratorio durante";
Blockly.Msg["ExpSECONDS"] = "segundos";
Blockly.Msg["ExpPAUSE"] = "pausa el laboratorio";
Blockly.Msg["ExpRESET"] = "resetea el laboratorio";
Blockly.Msg["ExpWHEN"] = "cuando ";
Blockly.Msg["ExpIS"] = "es";
Blockly.Msg["ExpLABSTEP"] = "en cada paso de laboratorio hacer";
Blockly.Msg["ExpWAIT"] = "esperar";
Blockly.Msg["ExpCHART"] = "crea gráfico";
Blockly.Msg["ExpYAXIS"] = "eje y";
Blockly.Msg["ExpEVAL"] = "evaluar";
Blockly.Msg["ExpCHARTOPTIONS"] = "- opciones";
Blockly.Msg["ExpCHARTPLOT"] = "   dibuja cada";
Blockly.Msg["ExpMILLISECONDS"] = "milisegundos";
Blockly.Msg["ExpCHARTLAST"] = "solo los últimos";
Blockly.Msg["ExpVALUES"] = "valores";
Blockly.Msg["ExpCHARTDATA"] = "- datos";
Blockly.Msg["ExpXAXIS"] = "eje x";
Blockly.Msg["ExpSTARTRECORD"] = "comenzar toma de datos";
Blockly.Msg["ExpSTOPRECORD"] = "detener toma de datos";
Blockly.Msg["ExpREPLACE"] = "remplazar función";
Blockly.Msg["ExpINPUT"] = "parametros de entrada";
...
Blockly.ControllerTextInitial ="Va a sobrescribir la función llamada ";
Blockly.ControllerTextSecond = " que tiene como parámetros de entrada ";
Blockly.ControllerTextThird = " y como salida ";
Blockly.ControllerTextForth = " nada";
Blockly.ControllerRemote = "Va a enviar este controlador al servidor y comprobar la documentación para ver qué variables se pueden utilizar.";
Blockly.Msg["Experiment"] = "Experimentos";
Blockly.Msg["Data"] = "Datos y gráficas";
Blockly.Msg["Event"] = "Eventos";
Blockly.Msg["Controller"] = "Controladores";
Blockly.Msg["NewVar"] = "Nombre de la nueva variable:";
Blockly.Msg["NewJavascript"] = "Nombre del nuevo código JavaScript:";
Blockly.Msg["NewExperimentScript"] ="Por favor, introduce el nombre del código del experimento";
Blockly.Msg["NewChartScript"] ="Por favor, introduce el nombre del código de la gráfica";
Blockly.Msg["NewEventScript"] ="Por favor, introduce el nombre del código del evento";
Blockly.Msg["NewControllerScript"] ="Por favor, introduce el nombre del código del controlador";
Blockly.Msg["NewExperimentScriptError"] ="Nombre del código del experimento ya usado";
Blockly.Msg["NewChartScriptError"] ="Nombre del código de la gráfica ya usado";
Blockly.Msg["NewEventtScriptError"] ="Nombre del código del evento ya usado";
Blockly.Msg["NewControllerScriptError"] ="Nombre del código del controlador ya usado";
Blockly.Msg["ForbiddenName"] ="Nombre prohibido, elige otro:";
Blockly.Msg["CreateVar"] ="Crear variable...";
Blockly.Msg["VarBoolean"] ="Booleana:";
Blockly.Msg["VarNumber"]="Numérica:";
Blockly.Msg["CreateJavaScript"] ="Crear JavaScript...";
Blockly.Msg["LoadJavaScript"] ="Cargar JavaScript...";
Blockly.Msg["ExpError"] ="No hay ningún experimento seleccionado para lanzar";
Blockly.Msg["Log1"] =" Quiero usar el";
Blockly.Msg["Log2"] =", viendo ";
Blockly.Msg["Log3"] =", con los eventos definidos en ";
Blockly.Msg["Log4"] =", usando ";
Blockly.Msg["EJSSFunctions"] = "Funciones del laboratorio";