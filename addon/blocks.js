function prepareBlocks(newImplement,keys_boolean,keys_boolean_output,keys_boolean_input,keys_number,keys_number_output,keys_number_input,visualJSGeneral,visualJSEvents,events_vars,function_from_ejss,function_from_ejss_with_return) {
	require(['mod_ejsapp/blockly_compressed','mod_ejsapp/blocks_compressed'], function (Blockly,Blocks) {
		...
		Blocks.set_model_variable_boolean = {
			init: function() {
				var addition;
				if (!newImplement) {
					addition = keys_boolean;
		...
		Blocks.get_model_variable_number = {
			init: function() {
				var addition;
				if (!newImplement) {
		...
		Blocks.set_model_variable_number = {
			init: function() {
				var addition;
				if (!newImplement) {
					addition = keys_number;
		...
		/* EVENTS */
		Blocks.set_model_variable_boolean2 = {
			init: function() {
				var addition;
				if (!newImplement) {
					addition = keys_boolean;
		...
		Blocks.set_model_variable_number2 = {
			init: function() {
				var addition;
				if (!newImplement) {
					addition = keys_number;
		...
		for (var i = 0; i < function_from_ejss.length; i++) {
			Blocks['ejss_procedures_callnoreturn' + function_from_ejss[i].name] = {
				init: function() {
		...
		for (var i = 0; i < function_from_ejss_with_return.length; i++) {
			...
			Blocks['ejss_procedures_callwithreturn' + function_from_ejss_with_return[i].name] = {
				init: function() {
